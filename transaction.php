    ...
    <?php
       ...
       if ($conn->query($sql) === TRUE) {  
        ...
        if (isset($_POST["submit"])){ 
            ...
            $devis = isset($_POST['devis']) ? htmlspecialchars(strtolower(trim($_POST['devis']))) : '';
            $typpe = isset($_POST['typpe']) ? htmlspecialchars(strtolower(trim($_POST['typpe']))) : '';
            $IdCompte = isset($_POST['IdCompte']) ? htmlspecialchars(strtolower(trim($_POST['IdCompte']))) : '';
    
            if ($montant && $devis && $typpe && $IdCompte) {
                $insertsql = "INSERT INTO transactions (montant,devis,typpe,IdCompte)
                                 VALUES('$montant','$devis','  $typpe','$IdCompte')"; 
