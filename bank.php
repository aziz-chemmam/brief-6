...
<body>
    ...
    <table class="w-[800px]" >
        ...
        <input class="px-5 py-2 rounded text-gray-300 bg-gray-700 " type="text" placeholder="NOM">
        
        <label for="nom"></label>
        <input class="px-5 py-2 rounded text-gray-300 bg-gray-700" type="text" placeholder="ADRESS">
        
        <label for="nom"></label>
        <input class="px-5 py-2 rounded text-gray-300 bg-gray-700" type="text" placeholder="BRAND LOGO">
        <div>
