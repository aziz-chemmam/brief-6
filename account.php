    ...
    //   echo "Table account created successfully";
      ...
      echo "Error creating table: " . $conn->error;
         ...
         if (isset($_POST["submit"])){ 
            ...
            $IdClient = isset($_POST['IdClient']) ? htmlspecialchars(strtolower(trim($_POST['IdClient']))) : '';
        
    
        if ($rib && $balance && $devis && $IdClient) {
            $insertsql = "INSERT INTO account(rib,balance,devis,IdClient)
                        VALUES('$rib','$balance','$devis',$IdClient)"; 
